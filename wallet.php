...
<Header class="header" id="header">
    ...
    <h1 style="margin-left: 30px;">Your wallet</h1>
    ...
    <?php
        ...
        echo "<h2 id=\"balance\" style=\"margin-left: 20px;\">Your Balance: $" . $row['balance'] . "</h2>";

        mysqli_close($conn);
    ?>

    <button class="button_sign" style="padding-left: 20px; margin-left: 40px;">
        <a href="place_order.php" style="color: white;">Trade now</a>
    </button>
    <button class="button_sign" style="padding-left: 20px;">
        <a href="deposit_withdraw.php" style="color: white;">Deposit/Withdraw</a>
    </button>
